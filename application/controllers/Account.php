			...
			if(count($usr)<1){
				...
				if($ret>0){
					...
					if($ret>0){
						...
						$code="200";
						$ttl="Success";$br="<br />";
						$content="Hi $nama, terima kasih sudah mendaftar.$br Akun anda adalah $nrp  $br Dan $pwd adalah Password anda.$br $br
						Untuk mengaktifkan akun anda silakan kontak admin $br $br $br rgds $br admin";
