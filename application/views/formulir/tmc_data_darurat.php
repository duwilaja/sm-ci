		...
		<!--form id="myf" class="form-horizontal"-->		
		  ...
		  <div class="row">
			<div class="form-group col-md-12">
				...
				<input type="text" id="deviceid" name="deviceid" placeholder="..." class="form-control">
			</div>
		  </div>
		<!--/form-->
	  </div>
...
$(document).ready(function(){
	...
	mytbl = $("#mytbl").DataTable({
		...
		ajax: {
			...
			data: function (d) {
				d.q= '<?php echo base64_encode("select jenis,count(jalan) as jumlah from tmc_data_darurat group by jenis"); ?>';
			}
		},
