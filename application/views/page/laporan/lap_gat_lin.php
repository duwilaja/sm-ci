				...
				<div class="e-panel card">
					...
					<div class="card-body">
						<table class="table" id="tabel">
							...
							<tbody>
								<tr>
									<td class="text-nowrap align-middle">SPRIN-DAH/004/XI/2020/POlDA</td>
                                    <td class="text-nowrap align-middle">Dikmas</td>
                                    <td class="text-nowrap align-middle">Laporan Pengajuan</td>
				...
				<div class="card">
					<div class="card-body">
						<div class="text-center">
							<button class="btn btn-primary btn-block" type="button" data-toggle="modal" data-target="#user-form-modal">New Entry</button>
                        </div>
						<div class="mt-4">
